  ...
  return (
    <div className='home'>
      ...
      <div className="features">
        <div className="container">
          <div className="item">
            ...
            <div className="title">
              <img src="./media/check.png" alt="check" />
              <h6>Quick completion of work</h6>
            </div>
            <p>Meet your perfect freelancer</p>
            <div className="title">
              <img src="./media/check.png" alt="check" />
      ...
      <div className="features dark">
        <div className="container">
          <div className="item">
            <h2>SkillSail business</h2>
            <h1>A business solution designed for <span>teams</span></h1>
            <p>Upgrade to a curated experience </p>
            <div className="title">
              <img src="./media/check.png" alt="check" />
              <h6>Connect to freelancers </h6>
            </div>
            <div className="title">
              <img src="./media/check.png" alt="check" />
            ...
            <div className="title">
              <img src="./media/check.png" alt="check" />
              <h6>Manage teamwork and boost productivity</h6>
            </div>
            <button>Explore SkillSail Business</button>
          </div>
          {/* <div className="item">
